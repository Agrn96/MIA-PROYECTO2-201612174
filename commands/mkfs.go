...
func Mkfs(idPart string, Type string, console *string) {
	...
	partitionType := typeOf(mountedPart.partition, console)
	...
	*console = *console + "[-] Formateo exitoso.\n"
}
